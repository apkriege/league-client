...
//   console.log("Matchups in FlightTeamOutput:", matchups);
//   const { league } = useLeagueStore();
...
//               {event.eventFormat === "individual" && event.scoringFormat === "stroke" && (
//                 <FlightStrokeOutput playerIds={flight} />
//               )}
//               {/* {event.eventFormat === "individual" && event.scoringFormat === "match" && (
//                 <FlightMatchOutput matchups={flight} />
//               )} */}
//               {event.eventFormat === "team" && event.scoringFormat === "match" && (
