...
export function EventInsightSection({
  title,
  description,
  action,
  children,
...
export function EventInsightEmpty({ children }: { children: ReactNode }) {
  return (
...
export function EventInsightBadge({ children }: { children: ReactNode }) {
  return (
