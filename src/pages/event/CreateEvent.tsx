...
import WizardType, { type EventWizardType } from "./builder/WizardType";
...
export default function CreateEvent() {
  ...
  const handleNext = () => {
    ...
    if (wizardType === "single") {
      navigate(`/league/${leagueId}/events/create/single`);
    } else {
      navigate(`/league/${leagueId}/events/create/multi`);
    }
  };
