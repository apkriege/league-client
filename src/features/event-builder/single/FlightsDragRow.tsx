...
const FlightTeamOutput = ({ matchups }: any) => {
  ...
  const team1 = league.teams.find((t) => t.id == matchups[0]);
  const team2 = league.teams.find((t) => t.id == matchups[1]);
...
export const FlightsDragRow = ({ event, flights, selected, setFlights }: FlightsDragRowProps) => {
  console.log("Rendering FlightsDragRow with flights:", selected);
        ...
        {fs.map((flight: any, fIdx: number) => (
          ...
          >
            ...
            <div className="flex flex-col text-sm">
              ...
              {event.type === "team" && event.scoringFormat === "match" && (
