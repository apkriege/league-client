...
export default function All({ event }: any) {
  const methods = useFormContext();

  const players = event.flights.flatMap((f: any) => f.players);
    ...
    <div className="score-table flex flex-col gap-4">
      <Card className="">
        <div className="overflow-x-scroll">
          <table className="table table-xs w-full horizontal-table mb-5 min-w-full whitespace-nowrap">
            <thead>
              {/* Headers */}
